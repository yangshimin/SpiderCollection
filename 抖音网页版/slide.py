...
class Slide(object):
    ...
    def __init__(self, gap, bg, gap_size=None, bg_size=None, out=None):
        ...
        gap_size = gap_size if gap_size else (54, 56)
...
if __name__ == "__main__":
    slide_info = {
        ...
        "data": {
            ...
            "cyfreso": 95,
            "host": "",
            "id": "fead6d3dd691fb37a9a2d44029161c572165f3a4",
            "mode": "slide",
            "question": {
                "url1": "https://p1-security.byteimg.com/img/rc-captcha/slide_fa22702a010a21ae5debb4c0a7a60e46294188a7_1.jpg~tplv-obj.image",
                "url2": "https://p1-security.byteimg.com/img/rc-captcha/slide_fa22702a010a21ae5debb4c0a7a60e46294188a7_2.png~tplv-obj.image",
                "tip_y": 34
            },
            "region": "",
            "version": 2
    ...
    slide_app = Slide(slide_info["data"]['question']['url2'], slide_info["data"]['question']['url1'])
