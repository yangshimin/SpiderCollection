...
var _cf = _cf || [],
    bmak = bmak && bmak["hasOwnProperty"]("ver") && bmak["hasOwnProperty"]("sed") ? bmak : {
      ...
      uar: function () {
        return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.88 Safari/537.36";
      },
      gd: function () {
        var t = bmak["uar"](),
            a = "" + bmak["ab"](t),
...
if (function (t) {
  ...
  t["fpcf"] = a,
    ...
    console.log("计算 fonts_optm value: ", n["join"](","));
    debugger;
    return n["join"](",");
  },
      a["fonts"] = function () {
    ...
    console.log("计算 fonts_optm value: ", t["join"](","));
    debugger;
    return t["join"](",");
  },
